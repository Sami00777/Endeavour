...
class MainListAdaptor: RecyclerView.Adapter<MainListAdaptor.MainListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainListViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_rec_view, parent, false)
